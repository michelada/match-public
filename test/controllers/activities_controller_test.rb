...
class ActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'loged user with team can create an activity' do
    team = teams(:team3)
    sign_in @user_with_team
    post activities_path, params: { activity: { name: 'Android Studio', activity_type: 'Curso',
                                                english: 0, description: 'description',
                                                pitch_audience: 'pitch', abstract_outline: 'abstract' },
                                    locations_string: 'UDEC,TEC' }
